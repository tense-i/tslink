#!/usr/bin/env python3
"""
load-test-runner - k6_script_generator.py
Generates k6 load test scripts based on user-defined parameters.
...
def main():
    parser = argparse.ArgumentParser(
        description="Generates k6 load test scripts based on user-defined parameters."
    )
    ...
    print(f"🚀 load-test-runner - k6_script_generator.py")
